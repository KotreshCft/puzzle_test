...
//public class SentinelMainManager : MonoBehaviour
//{
//    public static SentinelMainManager Instance { get; private set; }

//    [SerializeField] private PartySmartBlade blade;
//    [SerializeField] private SentinelObjectSpawner spawner;
...
//        {
//            imageComponent.sprite = isIncrease ? SentinelMainManager.Instance.increaseSprite : SentinelMainManager.Instance.decreaseSprite;
...
//        winnerName.text = PlayerName;             // Assign the winner's name
...
//        Debug.Log($"Update Leaderboard: {playerName + score}");
...
//    {
//        Debug.Log("Inside Update Leaderboard");
...
//        ShowLeaderboardAfterDelay();


//    }
//    public void  ShowLeaderboardAfterDelay()
//    {
...
public class SentinelMainManager : MonoBehaviour
{
    ...
    [SerializeField] private Text timerText;
    [SerializeField] private Image fadeImage;
    [SerializeField] private Image timerFillImage; // Add this field at the top of the class with other serialized fields


    public int score { get; private set; } = 0;

    // Public variable for setting the game duration from the Inspector (for testing and tweaking)
    // Private variable for loading the game duration from PlayerPrefs (for saved settings)
    // public float gameDuration = 60f;  // Game duration in seconds 
       private float gameDuration ;  // Game duration in seconds
    private float timeLeft;
    ...
    private void Start()
    {
        ...
        gameDuration = PlayerPrefs.GetFloat("gameDuration", 30f);
        Debug.Log("Loaded game duration: " + gameDuration);
    ...
    private IEnumerator Timer()
    {
        ...
        float initialGameDuration = gameDuration;  // Store the initial game duration
        ...
        while (timeLeft > 0)
        {
            ...
            // Calculate and set the fill amount (from 1 to 0)
            // This will start full and gradually empty as time passes
            timerFillImage.fillAmount = 1f - (initialGameDuration - timeLeft) / initialGameDuration;
