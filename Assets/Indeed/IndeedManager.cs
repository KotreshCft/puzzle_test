...
public class IndeedManager : MonoBehaviour
{
    public static IndeedManager Instance { get; private set; }
    ...
    private void SpawnFloatingImage(bool isIncrease, Vector3 worldPosition)
    {
        ...
        {
            imageComponent.sprite = isIncrease ? IndeedManager.Instance.increaseSprite : IndeedManager.Instance.decreaseSprite;
